    ...
    for i in range(iterations):
        ...
        for j in range(nbPlayers): # on fait bouger chaque joueur séquentiellement
            ...
            if (row,col) in fioles:
                ...
                game.mainiteration()
                couleur = fioles[(row,col)]
                print(game.layers['ramassable'].sprites()[0].tileid)
                print ("Objet de couleur ", couleur, " trouvé par le joueur ", j)
...
def newPosForFiole(couleur,tictactoeStates,wallStates,fioles):
    global game
